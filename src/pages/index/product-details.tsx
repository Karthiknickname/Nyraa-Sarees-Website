                  ...
                  >
                    <div className="relative text-center w-full z-10">
                      ...
                      <ul className="flex items-center justify-center gap-[10px] text-sm sm:text-base md:text-lg font-normal text-white mt-3 sm:mt-4 flex-wrap">
                        ...
                        <li>/</li>
                         <li>
                          <Link className="text-primary" to="/allproducts">Shop</Link>
                        </li>
                        ...
                        <div className="lg:max-w-[635px] w-full">
                            ...
                            >
                                <div className="flex gap-x-12 gap-y-3 flex-wrap">
                                    ...
                                    <h6 className="leading-none font-medium">
                                        Brand : {product?.brandName || "No brand name available."}
                                    </h6>
                                ...
                                <div className="flex gap-x-12 gap-y-3 flex-wrap mt-5 sm:mt-10">
                                    ...
                                    <h6 className="leading-none font-medium">
                                        Material : {product?.material || "No material available."}
                                    </h6>
                                </div>
                                <div className="flex gap-x-12 lg:gap-x-24 gap-y-3 flex-wrap mt-5 sm:mt-10">
                                    ...
                                    <div className="flex gap-[10px] items-center">
                                        ...
                                        <div className="flex gap-2">
                                         {variants
                                            .filter((v) => v.productId === product?.productId) // only variants for this product
                                            .map((variant: any) => (
                                          // {product?.Variants?.map((variant: any) => (
                                           <label key={variant.productVariantId} className="cursor-pointer">
                                             <input
                                               type="radio"
                                               name="variant"
                                               value={variant.productVariantId}
                                               checked={currentVariant?.productVariantId === variant.productVariantId}
                                               onChange={() => setCurrentVariant(variant)}
                                               className="hidden"
                                             />
                                             <span
  className={`inline-block w-8 h-8  border ${
    currentVariant?.productVariantId === variant.productVariantId
      ? 'border-20 border-black'  // Active variant: thick black border
      : 'border-gray-300'        // Default thin gray border
  }`}
  style={{
    backgroundColor: variant.productColor?.toLowerCase(),
    boxSizing: 'content-box',    // Ensure padding doesn’t shrink the color box size
