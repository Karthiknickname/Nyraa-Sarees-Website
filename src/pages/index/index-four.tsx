...
const handleAddToWishlist = async (variant: any) => {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5000/api/product-variants")
      ...
      .then((data) => {
        ...
        const arrivals = data.data.filter((variant: Variant) => variant.isNewArrival);
        const trendingProducts = data.data.filter((variant: Variant) => variant.isTrending);
  ...
  const fetchCollectionBanners = async () => {
    try {
      const res = await fetch("http://localhost:5000/api/collection-banners");
      const data = await res.json();
                            ...
                            <div className="group">
                              ...
                              <div className="mt-5 md:mt-7">
                                <h4 className="font-medium leading-none dark:text-white text-lg">
                                  <Price value={variant.Product.productOfferPrice} />
                                </h4>
